---
title: Vercel 확장 프로그램
description: Vercel MCP 서버를 goose 확장 프로그램으로 추가하여 배포 관리하기
---
...
이 튜토리얼에서는 goose에서 직접 Vercel 프로젝트와 배포 상태를 관리하기 위해 [Vercel MCP 서버](https://vercel.com/docs/mcp/vercel-mcp)를 goose 확장 프로그램으로 추가하는 방법을 다룹니다.

:::info
이 설치 명령은 `npx`를 사용하므로 시스템에 [Node.js](https://nodejs.org/)가 설치되어 있어야 합니다.
:::

:::tip 요약
<Tabs groupId="interface">
  <TabItem value="ui" label="goose Desktop" default>
  [설치 프로그램 실행](goose://extension?url=https%3A%2F%2Fmcp.vercel.com&type=streamable_http&id=vercel&name=Vercel&description=Access%20deployments%2C%20manage%20projects%2C%20and%20more%20with%20Vercel%E2%80%99s%20official%20MCP%20server)
  </TabItem>
...
<Tabs groupId="interface">
  <TabItem value="ui" label="goose Desktop" default>
    <GooseDesktopInstaller
      ...
      description="Vercel 배포 액세스 및 프로젝트 관리"
      type="http"
...
Vercel MCP 서버를 처음 사용할 때 OAuth를 통해 Vercel에 인증하라는 메시지가 표시됩니다.
